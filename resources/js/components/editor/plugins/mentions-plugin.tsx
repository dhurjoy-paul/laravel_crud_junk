import { LexicalTypeaheadMenuPlugin as TypeaheadMenuPluginType } from '@lexical/react/LexicalTypeaheadMenuPlugin';
import { JSX, lazy, useCallback, useEffect, useMemo, useState } from 'react';
...
) as unknown as typeof TypeaheadMenuPluginType;
        ...
        <LexicalTypeaheadMenuPlugin
            ...
            menuRenderFn={(
                ...
                return anchorElementRef.current && results.length
                    ? createPortal(
                          <div className="z-10 fixed shadow-md rounded-md w-[200px]">
                              <Command
                                  onKeyDown={(e) => {
                                      if (e.key === 'ArrowUp') {
                                          e.preventDefault();
