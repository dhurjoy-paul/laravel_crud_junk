                    ...
                    <main className="flex lg:flex-row flex-col-reverse w-full max-w-[335px] lg:max-w-4xl">
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block bg-[#1b1b18] hover:bg-black dark:bg-[#eeeeec] dark:hover:bg-white px-5 py-1.5 border border-black hover:border-black dark:border-[#eeeeec] dark:hover:border-white rounded-sm text-white dark:text-[#1C1C1A] text-sm leading-normal"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative bg-[#fff2f2] dark:bg-[#1D0002] -mb-px lg:mb-0 lg:-ml-px rounded-t-lg lg:rounded-t-none lg:rounded-r-lg w-full lg:w-[438px] aspect-[335/376] lg:aspect-auto overflow-hidden shrink-0">
                            ...
                            >
                                ...
                                <g className="opacity-100 starting:opacity-0 transition-all translate-y-0 starting:translate-y-4 duration-750 delay-300 mix-blend-plus-darker">
                                    <path
