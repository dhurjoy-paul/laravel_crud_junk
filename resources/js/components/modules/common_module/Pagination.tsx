...
export default function Pagination({ meta }: PaginationProps) {
    ...
    const renderLabel = (label: string) => {
        ...
        if (label === '...') return <MoreHorizontal className="w-4 h-4" />;
        return label;
    };
            ...
            <div className="flex sm:flex-row flex-col items-center gap-4 sm:gap-6">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="flex bg-transparent px-2 py-1 border border-input rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ring-offset-background w-[70px] h-8 text-sm cursor-pointer"
                    >
