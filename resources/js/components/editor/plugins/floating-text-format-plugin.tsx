...
function FloatingTextFormat({
    ...
    return (
        <div
            ...
            className="top-0 left-0 absolute flex gap-1 bg-background opacity-0 shadow-md p-1 border rounded-md transition-opacity duration-300 will-change-transform"
        >
            {editor.isEditable() && (
                <>
                    <ToggleGroup
